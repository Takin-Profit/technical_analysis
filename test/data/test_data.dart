...
Future<List<Quote>> getGoldAtr({int days = 750}) =>
    _getQuotes('gold_atr.csv', days);

Future<List<Quote>> getBtcMom({int days = 800}) =>
    _getQuotes('btc_mom.csv', days);

Future<List<Quote>> getAtrSlRma({int days = 800}) =>
    _getQuotes('atrsl_rma.csv', days);
...
Future<List<Quote>> getAtrSlWma({int days = 800}) =>
    _getQuotes('atrsl_wma.csv', days);
...
Future<List<Quote>> getBtcTsi({int days = 900}) =>
    _getQuotes('btc_tsi.csv', days);
